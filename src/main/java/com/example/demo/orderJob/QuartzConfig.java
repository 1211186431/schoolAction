...
public class QuartzConfig {
	 ...
	 * 创建任务
	 */
	public  void task(Job job,Map<String,Object> param,String key,int time) throws SchedulerException {
		Scheduler scheduler = new StdSchedulerFactory().getScheduler();
        // 开始
        scheduler.start();
        ...
        Trigger trigger = TriggerBuilder.newTrigger()
                .withIdentity(key)
                // 执行时间
                .startAt(new Date(System.currentTimeMillis() + 1000*60*1)).  //60秒后运行
